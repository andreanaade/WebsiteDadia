...
function dselect(el, option = {}) {
  ...
  function createDom() {
    ...
    <button type="button" class="btn ${classClearBtn}" id='clearbtn' title="Clear selection" onclick="dselectClear(this, '${classElement}')">
    ...
    ` : "";
    const template = `
    <div id="select-bangke" class="dropdown ${classElement} ${additionalClass}">
